...
class Game {
  ...
  // returns the y value of the lowest empty spot, or null if the row is full
  findSpotForCol(x) {
  ...
  // adds the chip of the correct color to the table
  placeInTable(y, x) {
  ...
  // I dont like that the alert shows up before the last chip...
  endGame(msg) {
    alert(msg);
  }
...
document.querySelector("#start").addEventListener("click", function (event) {
  ...
  console.log(document.querySelector("#p1color").value)
